...
Path Distillation is inspired by the observation in Seed Diffusion [arXiv:2508.02193] that training on high-quality generation paths can significantly improve model efficiency. This method consists of two main stages:
